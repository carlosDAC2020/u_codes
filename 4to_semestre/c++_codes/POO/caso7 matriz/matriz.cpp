...
void matriz::setfilas(int f) { filas = f; }

void matriz::setcolumnas(int c) { columnas = c; }
...
matriz matriz::producto_escalar() {
  int c;
  cout
      << " digitar el valor del numero por el que se va a multiplicar la matriz: ";
  cin >> c;
  matriz res;
  res.filas = filas;
  res.columnas = columnas;
