...
while True:
    ...
    # preguntamos al usuario si quiere repetir con otro metodo
    q=int(input(" ingrese el valor de 1 si no quiere repetir el programa:"))
    if q==1:
        break